...
//! 05-factory functions funciones dentro de funciones : version typescript
// import {getUUID, getAge}  from './plugins/Index';
...
// //! 07-logger winston : version typescript
// import { buildLogger } from "./plugins/logger.plugin"
// const logger = buildLogger("app.js")
// logger.error("hay un error")
// logger.log("first day in spring")